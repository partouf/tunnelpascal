...
*NOTE*: A list consists of comma separated items, e. g. `CPU=i386,m68k,powerpc`. No space between the elements and the comma.
...
#### Cross testing of target Mac OS with driver Darwin
