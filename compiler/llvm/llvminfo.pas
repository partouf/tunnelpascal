...
type
   tllvmversionflag = (
     ...
     llvmflag_sret_ty                       { type parameter is required to the sret and byref attributes }
   );
...
Const
   ...
   llvmversion_properties: array[tllvmversion] of tllvmversionflags =
     (
       ...
       { llvmver_12_0    } [llvmflag_memcpy_indiv_align,llvmflag_null_pointer_valid_new,llvmflag_constrained_fptrunc_fpext,llvmflag_constrained_fptoi_itofp,llvmflag_array_datalocation,llvmflag_sret_ty],
       { llvmver_13_0    } [llvmflag_memcpy_indiv_align,llvmflag_null_pointer_valid_new,llvmflag_constrained_fptrunc_fpext,llvmflag_constrained_fptoi_itofp,llvmflag_array_datalocation,llvmflag_sret_ty]
     );
