...
procedure SPI__STC_ISR; external name 'SPI__STC_ISR'; // Interrupt 12 Serial Transfer Complete
procedure USART__RXC_ISR; external name 'USART__RXC_ISR'; // Interrupt 13 USART, Rx Complete
procedure USART__UDRE_ISR; external name 'USART__UDRE_ISR'; // Interrupt 14 USART Data Register Empty
procedure USART__TXC_ISR; external name 'USART__TXC_ISR'; // Interrupt 15 USART, Tx Complete
