...
const
  ...
  MUIO_CoolButton    = 111; // label: STRPTR, CoolImage: APTR, flags: LongWord
  MUIO_ImageButton   = 112; // label: CONST_STRPTR, imagePath: CONST_STRPTR
  ...
  MUIO_CoolButton_CoolImageID      = 1 shl 0;
...
const
  ...
  MUI_EventHandlerRC_Eat = 1 shl 0; // do not invoke more handlers ers
...
const
  ...
  MUIA_Application_Version_Number  = MUIB_Application or $1; // Zune          i.g CONST_STRPTR Version number. Examples: "1.5", "2.37.4b".
  MUIA_Application_Version_Date    = MUIB_Application or $2; // Zune          i.g CONST_STRPTR Date information on the standard international YYYY-MM-DD format.
  MUIA_Application_Version_Extra   = MUIB_Application or $3; // Zune          i.g CONST_STRPTR Arbitrary extra version information. Example: "nightly build".
...
// Attributes
  MUIA_Frameadjust_Spec = MUIB_Frameadjust or $0; // Zune 20030330 ig. CONST_STRPTR
...
procedure MUI_RemoveClipping(Mri: PMUI_RenderInfo; Handle: APTR); syscall MUIMasterBase 25;
function MUI_AddClipRegion(Mri: PMUI_RenderInfo; Region: PRegion): APTR; syscall MUIMasterBase 26;
